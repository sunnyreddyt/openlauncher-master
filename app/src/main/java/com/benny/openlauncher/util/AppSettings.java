...
import com.benny.openlauncher.model.HideApp;
import com.benny.openlauncher.model.HideAppModel;
...
public class AppSettings extends SharedPreferencesPropertyBackend {
    ...
    public ArrayList<String> getHiddenAppsList() {
        ...
        Gson gson = new Gson();
        String json = preferences.getString("hideAppModel", "");
        HideAppModel hideAppModel = gson.fromJson(json, HideAppModel.class);

        ArrayList<String> arrayList = new ArrayList<String>();
        if (hideAppModel!=null) {
            for (int p = 0; p < hideAppModel.getHideAppArrayList().size(); p++) {
                arrayList.add(hideAppModel.getHideAppArrayList().get(p).getAppName());
            }
        }
    ...
    public void setHiddenAppsList(ArrayList<String> value) {
        ArrayList<HideApp> hideAppArrayList = new ArrayList<HideApp>();
        for (int p = 0; p < value.size(); p++) {
            HideApp hideApp = new HideApp();
            hideApp.setAppName(value.get(p));
            hideAppArrayList.add(hideApp);
        }
        HideAppModel hideAppModel = new HideAppModel();
        hideAppModel.setHideAppArrayList(hideAppArrayList);

        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        SharedPreferences.Editor prefsEditor = preferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(hideAppModel);
        prefsEditor.putString("hideAppModel", json);
        prefsEditor.commit();
    }
    ...
    public void setTimerListModel(TimerListModel timerListModel) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        SharedPreferences.Editor prefsEditor = preferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(timerListModel); // myObject - instance of MyObject
        prefsEditor.putString("timerListModel", json);
        prefsEditor.commit();
    }

    public TimerListModel getTimerListModel() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        Gson gson = new Gson();
        String json = preferences.getString("timerListModel", "");
        TimerListModel timerListModel = gson.fromJson(json, TimerListModel.class);
    ...
    public void setUserListModel(UserListModel userListModel) {
        ...
        SharedPreferences.Editor prefsEditor = preferences.edit();
        Gson gson = new Gson();
        String json = gson.toJson(userListModel); // myObject - instance of MyObject
        prefsEditor.putString("userListModel", json);
        prefsEditor.commit();
    }
    ...
    public UserListModel getUserListModel() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        Gson gson = new Gson();
        String json = preferences.getString("userListModel", "");
        UserListModel userListModel = gson.fromJson(json, UserListModel.class);
